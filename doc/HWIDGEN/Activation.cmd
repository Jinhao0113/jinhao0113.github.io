    ...
    echo     企业版、企业N、企业 （LTSB 2016）、教育版、教育N。
    echo ---------------------------------------------------------------
    ...
    echo ---------------------------------------------------------------
    echo 以下版本支持安装 16299  17134  17763 的证书。
    ...
    xcopy /i /y /q .\skus\%version%\%skus% "%SystemRoot%\System32\spp\tokens\skus\%skus%" >nul 2>nul || goto end
    echo ---------------------------------------------------------------
...
exit
    ...
    :end
    echo ---------------------------------------------------------------
    echo 证书复制失败！请检查 skus 目录是否完整，和系统版本是否支持！
    echo ---------------------------------------------------------------
    echo 按任意键退出脚本！
    pause >nul
exit
